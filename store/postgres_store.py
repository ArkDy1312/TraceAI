...
def insert_feature(
    workspace_id, feature_id, title, description, author, commit_ID=None, test_name=None
):
...
def update_commit_status(
    workspace_id, feature_id, commit_ID, status="Done", delete=False
):
    table_name = "features"
    if delete:
    ...
    with conn.cursor() as cur:
        ...
        """
            ...
            (workspace_id, feature_id, commit_ID),
        )
        ...
        if exists:
            ...
            """
                ...
                (commit_ID_update, status, workspace_id, feature_id, commit_ID),
            )
        else:
            # Insert row
            cur.execute(
            ...
            """
                ...
                (commit_ID, status, None, "Pending", workspace_id, feature_id),
            )
...
def update_test_status(
    workspace_id, feature_id, commit_ID, test_name, status="Done", delete=False
):
    table_name = "features"
    if delete:
    ...
    with conn.cursor() as cur:
        ...
        cur.execute(
            ...
            (workspace_id, feature_id, commit_ID, test_name),
        )
        ...
        if cur.fetchone():
            ...
            if cur.fetchone():
                ...
                """
                    ...
                    (test_name, status, workspace_id, feature_id, commit_ID),
                )
            else:
...
def get_commits_for_single_feature(workspace, feature_id, test_name):
    ...
    with conn.cursor() as cur:
        ...
        """
            ...
            (workspace, feature_id, test_name),
        )
